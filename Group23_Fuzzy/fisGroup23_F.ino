...
void setup()
{
    ...
    // Pin mode for Input: x
    pinMode(0 , INPUT);
    // Pin mode for Input: y
    pinMode(1 , INPUT);


    // initialize the Analog pins for output.
    // Pin mode for Output: z
    pinMode(2 , OUTPUT);
...
_FIS_MF fis_gMF[] =
{
    fis_trapmf, fis_gbellmf, fis_gauss2mf, fis_gaussmf, fis_trimf
};
...
FIS_TYPE fis_gMFI0Coeff1[] = { -5, -5, 5, 10 };
FIS_TYPE fis_gMFI0Coeff2[] = { 5, 15, 30, 40 };
FIS_TYPE fis_gMFI0Coeff3[] = { 35, 60, 72.9, 96.2 };
FIS_TYPE* fis_gMFI0Coeff[] = { fis_gMFI0Coeff1, fis_gMFI0Coeff2, fis_gMFI0Coeff3 };
FIS_TYPE fis_gMFI1Coeff1[] = { 0.597883597883598, 2.67, -5.55e-17 };
FIS_TYPE fis_gMFI1Coeff2[] = { 0.257, 0.905, 0.278, 1.76262710368779 };
FIS_TYPE fis_gMFI1Coeff3[] = { 1.20862433862434, 4.81, 3.87 };
FIS_TYPE* fis_gMFI1Coeff[] = { fis_gMFI1Coeff1, fis_gMFI1Coeff2, fis_gMFI1Coeff3 };
FIS_TYPE** fis_gMFICoeff[] = { fis_gMFI0Coeff, fis_gMFI1Coeff };

// Coefficients for the Output Member Functions
FIS_TYPE fis_gMFO0Coeff1[] = { -35, -35, -25 };
FIS_TYPE fis_gMFO0Coeff2[] = { -28, -18, -8 };
FIS_TYPE fis_gMFO0Coeff3[] = { -9, -4, 0 };
...
// Input range Max
FIS_TYPE fis_gIMax[] = { 70, 4 };

// Output range Min
FIS_TYPE fis_gOMin[] = { -40 };

// Output range Max
FIS_TYPE fis_gOMax[] = { 0 };
